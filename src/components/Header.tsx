      ...
      >
        ...
        <div className={`${!fromHome && "w-full bg-white"}`}>
          ...
          >
            ...
            {/* toggleMenu
                  ? ` -top-40 w-full md:w-1/2  z-50 flex flex-col items-start justify-start left-0 bg-white translate-x-0 transition-all ease duration-1000`
                  : `-left-[1500px] lg:left-5 bg-white -translate-x-full lg:translate-0 transition-all ease duration-1000 min-h-[2000px] lg:min-h-0 `
              }`} */}
            {/* <div
              className={` fixed lg:relative left-0 bg-white/50  z-50 transition-transform ease-in-out duration-1000 flex flex-row justify-start items-start lg:justify-center lg:items-center   ${
                toggleMenu
                  ? ` top-0 w-full flex flex-row justify-start items-start translate-x-0  `
                  : `w-full                                                                                                                                                                                                                                      lg:left-5  -translate-x-full lg:translate-0 transition-transform ease-in-out duration-1000 lg:min-h-0`
              }`} */}
            <div
