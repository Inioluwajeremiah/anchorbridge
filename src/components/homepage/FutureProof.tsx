...
const FutureProof = () => {
  ...
  return (
    // <div className="w-[94%]  lg:container mx-auto flex flex-col lg:flex-row items-start justify-between gap-x-10 py-10 md:py-14 lg:pt-24 px-5 md:px-10 lg:px-20 lg:py-20 ">
    //   <div className="w-full lg:w-1/2">
    //     <h1
    //       ref={ref}
    //       className={`${
    //         isVisible ? "scroll-reveal-bottom-top" : ""
    //       } text-xl md:text-2xl lg:text-3xl underline text-primary-color-two`}
    //     >
    //       Future-proof
    //     </h1>
    //     <h1
    //       className={`${
    //         isVisible ? "scroll-reveal-bottom-top" : ""
    //       } text-3xl md:text-4xl lg:text-5xl font-bold text-primary-color-two mt-3`}
    //     >
    //       Build. Scale. Thrive
    //     </h1>
    //     <p
    //       className={`${
    //         isVisible ? "scroll-reveal-bottom-top" : ""
    //       } text-text-color-dark mt-5 text-base lg:text-lg`}
    //     >
    ...
    //       className={`${
    //         isVisible ? "scroll-reveal-bottom-top" : ""
    //       } bg-black rounded-full py-4 px-10 cursor-pointer text-white my-10 lg:mb-0`}
    //     >
    ...
    //     className={`${
    //       isVisible ? "scroll-reveal-bottom-top" : ""
    //     } w-full  lg:max-w-1/2 relative h-fit  flex flex-col gap-4 lg:gap-0 md:flex-row items-start mt-10 md:mt-14 lg:mt-0 `}
    ...
    <div className="w-[94%]  lg:container mx-auto flex flex-col lg:flex-row items-start justify-between gap-x-10 py-10 md:py-14 lg:pt-24 px-5 md:px-10 lg:px-20 lg:pb-10 ">
      <div className="w-full lg:w-1/2">
        <h1
          className={`scroll-reveal-bottom-top text-xl md:text-2xl lg:text-3xl underline text-primary-color-two`}
        >
          Future-proof
        </h1>
        <h1
          className={`scroll-reveal-bottom-top text-3xl md:text-4xl lg:text-5xl font-bold text-primary-color-two mt-3`}
        >
          Build. Scale. Thrive
        </h1>
        <p
          className={`scroll-reveal-bottom-top text-text-color-dark mt-5 text-base lg:text-lg`}
        >
          Anchor Bridge Consulting is an innovative technology services and
          staff augmentation firm based in Fort Lauderdale, FL, USA and Lagos,
          Nigeria.
        ...
        <button
          className={`scroll-reveal-bottom-top bg-black rounded-full py-4 px-10 cursor-pointer text-white my-10 lg:mb-0`}
        >
          About Us
        </button>
      </div>
