...
const ResourcesCard: React.FC<IResourcesCard> = ({
  ...
  return (
    // <Link
    //   href={link}
    //   className={`w-[30%] h-[50vh] relative rounded-2xl bg-[url(https://anchorbridgeconsulting.com/wp-content/uploads/2025/08/industrial-designers-working-3d-model-min-scaled.jpg)] flex flex-col items-center gap-6 p-6 bg-contain duration-500 ease-linear shadow-box-shadow text-white group`}
    // >
    ...
    //   </div>
    //   <div className="h-full w-full flex flex-col justify-center items-center mt-4">
    ...
    // <Link
    //   href={link}
    //   className={`w-[30%] h-[50vh] relative rounded-2xl bg-[url(https://anchorbridgeconsulting.com/wp-content/uploads/2025/08/industrial-designers-working-3d-model-min-scaled.jpg)] flex flex-col items-center gap-6 p-6 bg-cover bg-center duration-500 ease-linear shadow-box-shadow text-white group`}
    // >
    //   {/* Transparent black overlay (always visible) */}
    //   <div className="absolute inset-0 bg-black/60 z-10 rounded-2xl" />

    //   {/* Content - place it above overlay using z-20 */}
    //   <div className="w-full flex flex-row items-center gap-2 z-20">
    //     <BiFolder size={25} color="#fff" />
    //     <h3 className="text-lg">{category}</h3>
    //   </div>

    //   <div className="h-full w-full flex flex-col justify-center items-center mt-4 z-20">
    //     <p className="text-white text-lg text-center">{date}</p>
    //     <h2 className="text-2xl font-bold text-white text-center">{title}</h2>
    //   </div>
    // </Link>
